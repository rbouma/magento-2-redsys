...
/**
 * Class Helper
 * @package Catgento\Redsys\Helper
 */
class CountryIsoHelper extends AbstractHelper
{
    ...
    /**
     * Returns the numeric code of a country from its two char iso cde
     *
     * @param $countryId
     * @return mixed
     */
    public function getCountryNumericCode($countryId)
    {
        return self::$countries[$countryId]['numeric'];
    }
}
